...
public class ExemploMap {
	...
	public static void main(String[] args) {
	    ...
	    System.out.println("Apague uma coleção: (0) ");
	    carrosPopulares.clear();
	
	    System.out.println("Confira se está vazio (0): " + carrosPopulares.isEmpty());
	    
	    System.out.println("Confira se está vazio (1): " + carrosPopulares1.isEmpty());
